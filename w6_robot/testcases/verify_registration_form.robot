...
Verify registration form with all input field
    ...
    Verify Text Field Value    input_comp-lt33fcsi1    ${PHONE}
    Input Valid Email Address
    Verify Text Field Value    input_comp-lt33fcsf1    ${EMAIL}
...
Verify registration form with single fault phone number
    ...
    Verify Text Field Value    input_comp-lt33fcsi1    ${INVALID_PHONE}
    Input Valid Email Address
    Verify Text Field Value    input_comp-lt33fcsf1    ${EMAIL}
    Select Number of Adults
    Select Pet Choice
...
Verify registration form with single fault email address
    ...
    Verify Text Field Value    input_comp-lt33fcsf1    ${INVALID_EMAIL}
    Select Number of Adults
    Select Pet Choice
    Input Note
    Verify Text Field Value    input_comp-lt33fct3    ${NOTE}
