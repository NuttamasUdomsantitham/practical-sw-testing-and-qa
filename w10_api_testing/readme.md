...
* **Detected from:** 🛒 POST Create Order (VALID)
* **Expected:** price × quantity
* **Actual:** The API returns a totalPrice that does not match the calculated value
* **Impact:** May result in incorrect billing for customers

---

### 🔴 2. Non-existent Order Returns 200 OK

* **Detected from:** 📦 Get Order (NOT FOUND)
* The API returns HTTP 200 even when the order does not exist
* Although the response contains an error message, the status code is incorrect
* **Expected:** 404 Not Found
* **Impact:** Misleads clients into thinking the request was successful

---

### 🔴 3. Missing Quantity Validation (Negative Values Allowed)

* **Detected from:** 🛒 POST Create Order (NEGATIVE QUANTITY)
* The API accepts negative values for quantity
* This allows creation of orders with negative totalPrice
* **Expected:** quantity must be greater than 0
* **Impact:** Leads to invalid data and potential exploitation
